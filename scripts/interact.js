...
const firstPhase = [1721001600, 1722470399, 0, ethers.parseEther("0.04"),   ethers.parseEther("8000000"),  ethers.parseEther("400000")]
...
async function main() {
    ...
    const vesting = await hre.ethers.getContractAt(
        "contracts/VestingAffiliate/VestingAffiliate.sol:VestingAffiliate",
        "0x16db05939731946aBd9720eB8ee937bA3dBE1eBD"
    )
