...
const phase6 = [1715185461, 1717815204, 0, ethers.parseEther("0.11"), ethers.parseEther("10000000"), ethers.parseEther("500000")]
...
async function main() {
    ...
    const Vesting = await hre.ethers.getContractFactory("contracts/Vesting.sol:Vesting");
    ...
    const approveTransaction = await cd.approve(vesting.target, phase6[4])
    ...
    const createPhaseTransaction = await vesting.createPhase(...phase6);
